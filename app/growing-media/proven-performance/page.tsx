...
const ligraTableRows = [
  { label: "Mean", controlA: "36.54 ± 3.06", controlB: "53.56 ± 2.58", t1: "60.95 ± 3.25", t2: "64.14 ± 3.73" },
  { label: "% of Control A", controlA: "–", controlB: "14.1", t1: "29.8", t2: "37.1" },
  { label: "% of Control B", controlA: "–", controlB: "–", t1: "13.8", t2: "20.1" },
];
...
export default function ProvenPerformancePage() {
  return (
    <>
      ...
      <section className="w-full bg-white px-4 py-14 sm:px-6 sm:py-20">
        <div className="mx-auto grid max-w-[1400px] gap-10 lg:grid-cols-[1.3fr_1fr] lg:items-start">
          ...
          >
            ...
            <motion.p variants={fadeUp} className="text-[30px] font-semibold" style={{ color: GREEN }}>
              Research at Temasek Polytechnic
            </motion.p>
            <motion.p variants={fadeUp} className="mt-3 text-[14px] leading-relaxed text-[#606060] sm:text-[15px]">
              The study, under controlled environment by Centre for Research and
              Opportunities in Plant Science, Temasek Polytechnic, shows that with
              the use of mGRO yields 20% more crops.
            </motion.p>

            <motion.div variants={scaleIn} className="relative mt-20 sm:mt-24">
              ...
              <motion.div
                ...
                viewport={viewportOnce}
                transition={{ duration: 0.7, delay: 0.4, ease: EASE, type: "spring", bounce: 0.35 }}
          ...
          <motion.div
            ...
            className="lg:mt-4"
          >
            <motion.div variants={fadeUp} className="rounded-2xl border border-[#dcecc8] p-3 sm:p-4">
            ...
            {/* Table */}
            <motion.div variants={fadeUp} className="mt-3 overflow-hidden rounded-xl border border-[#dcecc8]">
              <table className="w-full border-collapse text-center text-[12px] sm:text-[13px]">
                <thead>
                  <tr>
                    ...
                    <th className="border border-[#dcecc8] px-2 py-2 font-semibold text-white" style={{ backgroundColor: "#4C8FE8" }}>
                      Control A
                    </th>
                    <th className="border border-[#dcecc8] px-2 py-2 font-semibold text-white" style={{ backgroundColor: "#F2A649" }}>
                      Control B
                    </th>
                    <th className="border border-[#dcecc8] px-2 py-2 font-semibold text-white" style={{ backgroundColor: "#5FA857" }}>
                      T1
                    </th>
                    <th className="border border-[#dcecc8] px-2 py-2 font-semibold text-white" style={{ backgroundColor: "#D9534F" }}>
                      T2
                    </th>
                  </tr>
                </thead>
                <tbody>
                  {ligraTableRows.map((row, i) => (
                    <tr key={row.label} className={i % 2 === 0 ? "bg-[#FAFFF0]" : "bg-white"}>
                      <td className="border border-[#dcecc8] px-2 py-2 text-left font-medium text-[#606060]">{row.label}</td>
                      <td className="border border-[#dcecc8] px-2 py-2 text-[#606060]">{row.controlA}</td>
                      <td className="border border-[#dcecc8] px-2 py-2 text-[#606060]">{row.controlB}</td>
                      <td className="border border-[#dcecc8] px-2 py-2 text-[#606060]">{row.t1}</td>
                      <td className="border border-[#dcecc8] px-2 py-2 text-[#606060]">{row.t2}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
            ...
            {/* Notes */}
            <motion.div variants={fadeUp} className="mt-3 space-y-2">
              <div className="flex items-center gap-3 rounded-xl">
                <Image src="/images/mgro/icon/icon-treegreen.svg" alt="" width={20} height={20} className="mt-0.5 h-12 w-12 shrink-0" />
                <p className="text-[13px] leading-relaxed text-[#606060]">
                  Both T2 and Control B contain bio-organisms, allowing for a fair
                  assessment of the growth impact from LiGrA in T2.
                </p>
              </div>
              <div className="flex items-center gap-3 rounded-xl">
                <Image src="/images/mgro/icon/icon-bullgreen.svg" alt="" width={20} height={20} className="mt-0.5 h-12 w-12 shrink-0" />
                <p className="text-[13px] leading-relaxed text-[#606060]">
      ...
      {/* EDIBLE GREEN WALL */}
      <section className="w-full px-4 py-14 sm:px-6 sm:py-20" style={{ backgroundColor: "#FAFFF0" }}>
        <div className="mx-auto grid max-w-[1400px] gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:items-center">
          <motion.div
            ...
            variants={staggerContainer}
          >
            <motion.p variants={fadeUp} className="text-[30px] font-bold tracking-wide" style={{ color: GREEN }}>
              Featured in
            </motion.p>
            <motion.h2
              variants={fadeUp}
            ...
            <motion.p variants={fadeUp} className="mt-3 text-[14px] leading-relaxed text-[#606060] font-light sm:text-[16px]">
              Launched by the Singapore Sustainability Academy, the Edible Green
              Wall utilizes potting soil combined with LiGrA as the growth medium
              for plants.
            </motion.p>
            <motion.p variants={fadeUp} className="mt-4 text-[14px] font-bold text-[#606060] sm:text-[20px]">
              Benefit of using mGRO:
            </motion.p>
            <motion.p variants={fadeUp} className="mt-1 text-[14px] leading-relaxed text-[#606060] font-light sm:text-[16px]">
        ...
        <div className="mx-auto max-w-[1400px]">
          ...
          >
            {structuralAdvantages.map((item, i) => (
              ...
              >
                <Image src={item.iconSrc} alt="" width={32} height={32} className="h-20 w-20 shrink-0" />
                <div>
                  <p className="text-[14px] font-bold text-[#606060] sm:text-[15px]">{item.title}:</p>
                  <p className="mt-1 text-[13px] leading-relaxed text-[#606060] sm:text-[14px]">{item.body}</p>
                </div>
              </motion.div>
            ))}
          </motion.div>
      ...
      <section className="w-full px-4 py-14 sm:px-6 sm:py-20">
        <div className="mx-auto grid max-w-[1400px] gap-26 lg:grid-cols-[1.1fr_1fr] lg:items-center">
          ...
          >
            ...
            <motion.h2 variants={fadeUp} className="-mt-6 text-[20px] font-bold sm:text-[40px]" style={{ color: DARK_GREEN }}>
              Proven in Taman Damai
              <br />
              Communal Garden
            </motion.h2>
            <motion.p variants={fadeUp} className="mt-3 text-[14px] leading-relaxed text-[#606060] sm:text-[16px]">
            ...
            <motion.p variants={fadeUp} className="mt-3 text-[14px] leading-relaxed text-[#606060] sm:text-[16px]">
              A 40% mGRO : 60% soil mixture was used to reduce the stickiness of
              the clayey soil while maintaining favourable conditions for plant
              growth.
            </motion.p>
          </motion.div>
        </div>
      ...
      <section className="w-full bg-white px-4 py-14 sm:px-6 sm:py-20">
        <div className="mx-auto grid max-w-[1400px] gap-26 lg:grid-cols-[1fr_1.1fr] lg:items-center">
          ...
          >
            ...
            <motion.p variants={fadeUp} className="mt-3 text-[14px] leading-relaxed text-[#606060] sm:text-[16px]">
              Kang Kong seeds were grown in two different growing media: 100% soil
              and a 50:50 mGRO-soil blend (by volume). Both media produced healthy
              shoots within 5 days, while the mGRO composite weighed only 55% as
              much as soil, creating a significantly lighter growing medium.
            </motion.p>
            <motion.p variants={fadeUp} className="mt-3 text-[14px] leading-relaxed text-[#606060] sm:text-[16px]">
              These promising results support the continued exploration of mGRO
              as a sustainable solution for horticultural applications.
            </motion.p>
          </motion.div>
